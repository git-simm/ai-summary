 ...
 */
public class CustomSseClientTransport implements McpClientTransport {

    private static final Logger logger = LoggerFactory.getLogger(CustomSseClientTransport.class);
    ...
    CustomSseClientTransport(HttpClient httpClient, HttpRequest.Builder requestBuilder, String baseUri,
                                 String sseEndpoint, ObjectMapper objectMapper,Consumer<HttpRequest.Builder> consumerRequest) {
     ...
     */
    public static CustomSseClientTransport.Builder builder(String baseUri) {
        return new CustomSseClientTransport.Builder().baseUri(baseUri);
    }

    /**
     * Builder for {@link io.modelcontextprotocol.client.transport.HttpClientSseClientTransport}.
     */
    public static class Builder {
         ...
         * @param baseUri the base URI of the MCP server
         * @deprecated Use {@link io.modelcontextprotocol.client.transport.HttpClientSseClientTransport#builder(String)} instead.
         ...
         * @return this builder
         */
        CustomSseClientTransport.Builder baseUri(String baseUri) {
            Assert.hasText(baseUri, "baseUri must not be empty");
            this.baseUri = baseUri;
            return this;
        }
         ...
         * @return this builder
         */
        public CustomSseClientTransport.Builder sseEndpoint(String sseEndpoint) {
            Assert.hasText(sseEndpoint, "sseEndpoint must not be empty");
            this.sseEndpoint = sseEndpoint;
            return this;
        }
         ...
         * @return this builder
         */
        public CustomSseClientTransport.Builder clientBuilder(HttpClient.Builder clientBuilder) {
         ...
         * @return this builder
         */
        public CustomSseClientTransport.Builder customizeClient(final Consumer<HttpClient.Builder> clientCustomizer) {
         ...
         * @return this builder
         */
        public CustomSseClientTransport.Builder requestBuilder(HttpRequest.Builder requestBuilder) {
            Assert.notNull(requestBuilder, "requestBuilder must not be null");
            this.requestBuilder = requestBuilder;
            return this;
        }
         ...
         * @return this builder
         */
        public CustomSseClientTransport.Builder customizeRequest(final Consumer<HttpRequest.Builder> requestCustomizer) {
        ...
        /**
         * http 请求拦截
         * @param consumerRequest the consumer to customize the HTTP request builder
         * @return this builder
         */
        public CustomSseClientTransport.Builder consumerRequest(final Consumer<HttpRequest.Builder> consumerRequest) {
            Assert.notNull(consumerRequest, "consumerRequest must not be null");
            this.consumerRequest = consumerRequest;
            return this;
        }
         ...
         * @return this builder
         */
        public CustomSseClientTransport.Builder objectMapper(ObjectMapper objectMapper) {
            Assert.notNull(objectMapper, "objectMapper must not be null");
            this.objectMapper = objectMapper;
            return this;
        }
        ...
        /**
         * Builds a new {@link io.modelcontextprotocol.client.transport.HttpClientSseClientTransport} instance.
         * @return a new transport instance
         */
        public CustomSseClientTransport build() {
            return new CustomSseClientTransport(clientBuilder.build(), requestBuilder, baseUri, sseEndpoint,
                    objectMapper,consumerRequest);
        }
    ...
    public Mono<Void> connect(Function<Mono<McpSchema.JSONRPCMessage>, Mono<McpSchema.JSONRPCMessage>> handler) {
        ...
        // 请求前置处理，可以追加header
        if(this.consumerRequest!=null){
            this.consumerRequest.accept(this.requestBuilder);
        }
